$(document).ready(function () {
  ...
  if (window.location.href.indexOf('schedule') > -1) {
    ...
    const c = e(
        ...
        e('div', {class: 'card mb-5'}, e('h5', {class: 'card-header'}, 'Day 1'), ...a(s.slice(0, 3)))
      ),
      l = e(
        'div',
        {class: 'container'},
        e('div', {class: 'card mb-5'}, e('h5', {class: 'card-header'}, 'Day 2'), ...a(s.slice(3, 6)))
      ),
      d = e(
        'div',
        {class: 'container'},
        e('div', {class: 'card mb-5'}, e('h5', {class: 'card-header'}, 'Day 3'), ...a(s.slice(6, 9)))
      );
